...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_dom_node_collection_js__ = __webpack_require__(0);
...
window.$l = argument => {
  if (typeof argument === 'string') {
    ...
    return new __WEBPACK_IMPORTED_MODULE_0__lib_dom_node_collection_js__["a" /* default */](selectorArray);
  } else if (argument instanceof HTMLElement) {
    return new __WEBPACK_IMPORTED_MODULE_0__lib_dom_node_collection_js__["a" /* default */]([argument]);
